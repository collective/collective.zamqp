...
- amqp-consuming-server
  ...
  ``vhm_site_url`` (optional)
       Explicitly set the VHM url for the site. The url will prefix the AMQP
       method paths so that VHM can tell portal the configured real public
       hostname and path.
